    ...
    <div>
      ...
      <div className="bg-gradient-to-b from-gray-50 to-white min-h-screen px-4 py-16 sm:px-6 lg:px-12">
        ...
        <section className=" py-12 px-4 sm:px-6 lg:px-12">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-800 tracking-tight mb-4">
              Recognized for Excellence
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              SwanSorter has earned accolades for innovation, reliability, and
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 items-center justify-items-center max-w-6xl mx-auto">
            <motion.img
              src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1746798825/Awards_copy_u2ceyg.jpg"
              alt="Award 1"
              className="h-52 object-contain"
              whileHover={{ scale: 1.1, rotate: 2 }}
            />
            <motion.img
              src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1746798825/Awards_copy_-_Copy_3_urzkul.jpg"
              alt="Award 2"
              className="h-52 object-contain"
              whileHover={{ scale: 1.1, rotate: -2 }}
            />
            <motion.img
              src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1746798825/Awards_copy_-_Copy_4_mpbmtg.jpg"
              alt="Award 3"
              className="h-52 object-contain"
              whileHover={{ scale: 1.1, rotate: 1 }}
            />
            <motion.img
              src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1746798825/Awards_copy_-_Copy_2_nht68m.jpg"
              alt="Award 4"
              className="h-52 object-contain"
              whileHover={{ scale: 1.1, rotate: -1 }}
            />
            <motion.img
              src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1746798825/Awards_copy_-_Copy_j4imeh.jpg"
              alt="Award 5"
              className="h-52 object-contain"
              whileHover={{ scale: 1.1, rotate: 2 }}
            />
