    ...
    <div className=" text-gray-900">
      ...
      <section className="py-10 px-6 text-center">
        <div className="flex justify-center">
          <Image
            src="https://res.cloudinary.com/dt2juqy9s/image/upload/v1746797495/WhatsApp_Image_2025-05-09_at_3.30.27_PM_txsmft.jpg"  // Placeholder image URL
            alt="Company Showcase"
            width={400} // Set the desired width
            height={400} // Set the desired height
            className="rounded-lg shadow-lg object-cover" // Add some styling
          />
        </div>
      </section>
