...
const solutions = [
  {
    ...
    items: [
      ...
      //Done
      {
        ...
        images: [
          {
            src: "/PINE_NUTS.jpg", // Add image path if available
            title: "Pine Nuts",
            details: {
              points: [
      ...
      //done
      {
        ...
        images: [
          {
            src: "/DEHYRDATED_ONION.webp", // Add image path if available
          ...
          {
            src: "/DEHYRDATED_GARLIC.jpg", // Add image path if available
...

      {
        ...
        images: [
          {
            src: "/JEERA_SEED.webp", // Add image path if available
            title: "Jeera",
            details: {
              points: [
      ...
      //Done 2
      {
        ...
        images: [
          {
            src: "/PEELED_GARLIC.jpg", // Add image path if available
            title: "Peeled Garlic",
            details: {
              points: [
...

      {
        ...
        images: [
          {
            src: "/360_F_330663476_IqeXjQErtp6l8CddOKMYSCfDj6lXCrAL.webp", // Add image path if available
            title: "Coffee Fruit",
            details: {
              points: [
                ...
                <div className="flex flex-col lg:flex-row gap-8 w-full">
                  ...
                  <div className="lg:w-1/2">
                    ...
                    <div className="mt-8">
                        ...
                        {(selectedItem.recommended || []).map((rec, idx) => (
                          ...
                          >
                            <Image
                              ...
                              width={100}
                              height={120}
                              className="rounded-md object-cover h-28 w-32"
                            />
                      ...
                      <Link
                        href="/Orders"
                        className=" bg-gradient-to-r from-green-400 to-blue-400 text-center text-white hover:underline font-semibold py-2 px-4 rounded"
                      >
                        Enquiry Now
                      </Link>
                    </div>
